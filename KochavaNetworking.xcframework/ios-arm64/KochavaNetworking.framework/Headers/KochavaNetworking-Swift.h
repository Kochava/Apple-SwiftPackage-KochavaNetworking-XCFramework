...
@class KVANetworking;
/// A protocol which provides a networking instance.
SWIFT_PROTOCOL_NAMED("Provider")
...
SWIFT_CLASS("_TtC17KochavaNetworking6Format")
@interface Format : NSObject <KVANetworking_Provider>
...
/// \param jsonObject A JSON object to serialize.
///
...
/// A protocol which provides a <code>PrivacyProfile/Registrar</code>.
SWIFT_PROTOCOL_NAMED("RegistrarProvider")
@protocol KVAPrivacyProfile_RegistrarProvider
/// A property which conforms to protocol Registrar.
...
///
/// \param closure_didComplete A closure which is executed when the instruction completes, providing a JSON string representation of the result.
///
...
@class KVANetworking_Privacy_IntelligentConsent;
/// A feature which is responsible for privacy, including <code>Networking/Privacy/intelligentConsent</code>.
...
/// A feature which provides intelligent management of consent as it relates to the sharing of personal data.
...
@property (nonatomic, readonly, strong) KVANetworking_Privacy_IntelligentConsent * _Nonnull intelligentConsent;
/// An instance of networking.
@property (nonatomic, weak) KVANetworking * _Nullable networking;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
@interface KVANetworking_Privacy (SWIFT_EXTENSION(KochavaNetworking))
@end
...
SWIFT_CLASS_NAMED("IntelligentConsent")
@interface KVANetworking_Privacy_IntelligentConsent : NSObject <NSCopying, KVANetworking_Provider>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// This API is provided for Objective-C support.  In Swift use var <code>IntelligentConsent/grantedBool</code>.
...
///
/// \param registrarArray An array of RegistrarProvider to which to register the PrivacyProfile.
///
...
/// A shared instance, for convenience— optional.
/// See var <code>shared</code>.  This variable will be nil prior to the shared instance being defaulted.  This may be used to optionally invalidate any existing shared instance without causing it to first be defaulted in the process.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) KochavaNetworking_Product * _Nullable shared_optional;)
+ (KochavaNetworking_Product * _Nullable)shared_optional SWIFT_WARN_UNUSED_RESULT;
/// Resets the product.
